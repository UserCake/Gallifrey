...
public class EntityAIOcelotSit extends EntityAIBase
{
    ...
    {
        return field_50085_a.getRNG().nextDouble() <= 0.013500000350177288D && func_50077_h();
    }
    ...
    {
        return field_50084_c <= field_50081_d && func_50078_a(field_50085_a.worldObj, field_50082_e, field_50079_f, field_50080_g);
    }
    ...
    public void startExecuting()
    {
        ...
        field_50084_c = 0;
        field_50081_d = field_50085_a.getRNG().nextInt(field_50085_a.getRNG().nextInt(2400) + 2400) + 2400;
    ...
    private boolean func_50077_h()
    {
        ...
        for (int j = (int)field_50085_a.posX - 7; (double)j < field_50085_a.posX + 7D; j++)
        {
            for (int k = (int)field_50085_a.posZ - 7; (double)k < field_50085_a.posZ + 7D; k++)
            {
