...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleOpenWindow(Packet100OpenWindow par1Packet100OpenWindow)
    {
        ...
        {
            EntityPlayerSP entityplayersp = mc.thePlayer;
            mc.thePlayer.displayWorkbenchGUI(MathHelper.floor_double(entityplayersp.posX), MathHelper.floor_double(entityplayersp.posY), MathHelper.floor_double(entityplayersp.posZ));
            mc.thePlayer.craftingInventory.windowId = par1Packet100OpenWindow.windowId;
        }
        else if (par1Packet100OpenWindow.inventoryType == 4)
        {
            EntityPlayerSP entityplayersp1 = mc.thePlayer;
            mc.thePlayer.displayGUIEnchantment(MathHelper.floor_double(entityplayersp1.posX), MathHelper.floor_double(entityplayersp1.posY), MathHelper.floor_double(entityplayersp1.posZ));
            mc.thePlayer.craftingInventory.windowId = par1Packet100OpenWindow.windowId;
        }
    }
    ...
    {
        mc.thePlayer.capabilities.isFlying = par1Packet202PlayerAbilities.field_50070_b;
        mc.thePlayer.capabilities.isCreativeMode = par1Packet202PlayerAbilities.field_50069_d;
        mc.thePlayer.capabilities.disableDamage = par1Packet202PlayerAbilities.field_50072_a;
        mc.thePlayer.capabilities.allowFlying = par1Packet202PlayerAbilities.field_50071_c;
    }
