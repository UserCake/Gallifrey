...
public class LoadingScreenRenderer implements IProgressUpdate
{
    ...
    public void setLoadingProgress(int par1)
    {
        ...
        mc.fontRenderer.func_50103_a(currentlyDisplayedText, (i - mc.fontRenderer.getStringWidth(currentlyDisplayedText)) / 2, j / 2 - 4 - 16, 0xffffff);
        mc.fontRenderer.func_50103_a(field_1004_a, (i - mc.fontRenderer.getStringWidth(field_1004_a)) / 2, (j / 2 - 4) + 8, 0xffffff);
        Display.update();
