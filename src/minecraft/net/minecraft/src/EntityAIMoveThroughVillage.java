...
public class EntityAIMoveThroughVillage extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        field_48291_c = theEntity.getNavigator().func_48671_a(doorInfo.posX, doorInfo.posY, doorInfo.posZ);
        ...
        {
            theEntity.getNavigator().setBreakDoors(false);
            field_48291_c = theEntity.getNavigator().func_48671_a(vec3d.xCoord, vec3d.yCoord, vec3d.zCoord);
            theEntity.getNavigator().setBreakDoors(flag);
