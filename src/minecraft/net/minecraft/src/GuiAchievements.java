    ...
    protected void genAchievementBackground(int par1, int par2, float par3)
    {
        ...
        if (achievement != null)
        {
            ...
            if (statFileWriter.canUnlockAchievement(achievement2))
            {
                ...
                if (statFileWriter.hasAchievementUnlocked(achievement2))
                {
                    fontRenderer.func_50103_a(StatCollector.translateToLocal("achievement.taken"), i5, l5 + l6 + 4, 0xff9090ff);
                }
            }
            else
            {
            ...
            fontRenderer.func_50103_a(s, i5, l5, statFileWriter.canUnlockAchievement(achievement2) ? achievement2.getSpecial() ? -128 : -1 : achievement2.getSpecial() ? 0xff808040 : 0xff808080);
        }
