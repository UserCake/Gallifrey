...
public abstract class Minecraft implements Runnable
{
    ...
    private void displayDebugInfo(long par1)
    {
        ...
        int j4 = 0xffffff;
        fontRenderer.func_50103_a(s, i2 - j1, k2 - j1 / 2 - 16, j4);
        fontRenderer.func_50103_a(s = (new StringBuilder()).append(decimalformat.format(profilerresult.globalPercentage)).append("%").toString(), (i2 + j1) - fontRenderer.getStringWidth(s), k2 - j1 / 2 - 16, j4);
        ...
        for (int k3 = 0; k3 < list.size(); k3++)
        {
            ...
            fontRenderer.func_50103_a(s1, i2 - j1, k2 + j1 / 2 + k3 * 8 + 20, profilerresult2.getDisplayColor());
            fontRenderer.func_50103_a(s1 = (new StringBuilder()).append(decimalformat.format(profilerresult2.sectionPercentage)).append("%").toString(), (i2 + j1) - 50 - fontRenderer.getStringWidth(s1), k2 + j1 / 2 + k3 * 8 + 20, profilerresult2.getDisplayColor());
            fontRenderer.func_50103_a(s1 = (new StringBuilder()).append(decimalformat.format(profilerresult2.globalPercentage)).append("%").toString(), (i2 + j1) - fontRenderer.getStringWidth(s1), k2 + j1 / 2 + k3 * 8 + 20, profilerresult2.getDisplayColor());
        }
    }
    ...
    public void runTick()
    {
        ...
        if (currentScreen == null || currentScreen.allowUserInput)
        {
            ...
            if (isMultiplayerWorld() && Keyboard.isKeyDown(53))
            {
