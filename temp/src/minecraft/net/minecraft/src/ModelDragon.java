...
public class ModelDragon extends ModelBase
{
    ...
    public void func_864_b(Entity p_864_1_, float p_864_2_, float p_864_3_, float p_864_4_, float p_864_5_, float p_864_6_, float p_864_7_)
    {
        ...
        for(int i = 0; i < 5; i++)
        {
            ...
            field_40312_b.field_1407_d = f8 + (((float)(ad3[1] - ad[1]) * 3.141593F) / 180F) * f5 * 5F;
        ...
        {
            GL11.glEnable(2884);
            float f10 = f * 3.141593F * 2.0F;
            field_40319_q.field_1407_d = 0.125F - (float)Math.cos(f10) * 0.2F;
            field_40319_q.field_1406_e = 0.25F;
            field_40319_q.field_1405_f = (float)(Math.sin(f10) + 0.125D) * 0.8F;
            field_40318_r.field_1405_f = -(float)(Math.sin(f10 + 2.0F) + 0.5D) * 0.75F;
        ...
        GL11.glDisable(2884);
        f8 = -(float)Math.sin(f * 3.141593F * 2.0F) * 0.0F;
        f9 = f * 3.141593F * 2.0F;
        f2 = 10F;
        f3 = 60F;
        f4 = 0.0F;
        ...
        for(int k = 0; k < 12; k++)
        {
            ...
            field_40312_b.field_1407_d = f8 + (((float)(ad2[1] - ad[1]) * 3.141593F) / 180F) * f5 * 5F;
