...
public class GuiButton extends Gui
{
    ...
    public GuiButton(int p_i772_1_, int p_i772_2_, int p_i772_3_, int p_i772_4_, int p_i772_5_, String p_i772_6_)
    {
        ...
        field_935_a = p_i772_4_;
        field_934_b = p_i772_5_;
    ...
    public void func_561_a(Minecraft p_561_1_, int p_561_2_, int p_561_3_)
    {
        ...
        boolean flag = p_561_2_ >= field_941_c && p_561_3_ >= field_940_d && p_561_2_ < field_941_c + field_935_a && p_561_3_ < field_940_d + field_934_b;
        int i = func_558_a(flag);
        func_550_b(field_941_c, field_940_d, 0, 46 + i * 20, field_935_a / 2, field_934_b);
        func_550_b(field_941_c + field_935_a / 2, field_940_d, 200 - field_935_a / 2, 46 + i * 20, field_935_a / 2, field_934_b);
    ...
    {
        return field_937_g && field_936_h && p_562_2_ >= field_941_c && p_562_3_ >= field_940_d && p_562_2_ < field_941_c + field_935_a && p_562_3_ < field_940_d + field_934_b;
    }
}
