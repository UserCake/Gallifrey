...
public class EffectRenderer
{
    ...
    {
        float f = MathHelper.func_1114_b((p_1187_1_.field_605_aq * 3.141593F) / 180F);
        float f1 = MathHelper.func_1106_a((p_1187_1_.field_605_aq * 3.141593F) / 180F);
        float f2 = -f1 * MathHelper.func_1106_a((p_1187_1_.field_604_ar * 3.141593F) / 180F);
        float f3 = f * MathHelper.func_1106_a((p_1187_1_.field_604_ar * 3.141593F) / 180F);
        float f4 = MathHelper.func_1114_b((p_1187_1_.field_604_ar * 3.141593F) / 180F);
        byte byte0 = 3;
