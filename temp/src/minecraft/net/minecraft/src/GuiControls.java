...
public class GuiControls extends GuiScreen
{
    ...
    public void func_571_a(int p_571_1_, int p_571_2_, float p_571_3_)
    {
        ...
        {
            boolean flag = false;
            for(int k = 0; k < field_956_i.field_1564_t.length; k++)
            {
            ...
            if(field_955_j == j)
            {
                ((GuiButton)field_949_e.get(l)).field_939_e = "\247f> \247e??? \247f<";
            } else
            if(flag)
            {
                ((GuiButton)field_949_e.get(l)).field_939_e = (new StringBuilder()).append("\247c").append(field_956_i.func_1047_d(l)).toString();
            } else
            {
                ((GuiButton)field_949_e.get(l)).field_939_e = field_956_i.func_1047_d(l);
            }
