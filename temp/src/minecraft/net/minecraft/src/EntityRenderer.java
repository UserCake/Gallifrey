...
//            RenderHelper, EffectRenderer, InventoryPlayer, BiomeGenBase, 
//            EntitySmokeFX, EntityRainFX, Tessellator, WorldChunkManager, 
...
public class EntityRenderer
{
    ...
    private void func_4139_a(float p_4139_1_, int p_4139_2_)
    {
        ...
        if(field_21155_l != 1.0D)
        {
            ...
            GLU.gluPerspective(func_914_d(p_4139_1_, true), (float)field_1388_h.field_6326_c / (float)field_1388_h.field_6325_d, 0.05F, field_1387_i * 2.0F);
        } else
        {
            GLU.gluPerspective(func_914_d(p_4139_1_, true), (float)field_1388_h.field_6326_c / (float)field_1388_h.field_6325_d, 0.05F, field_1387_i * 2.0F);
        }
        ...
        float f2 = field_1388_h.field_6322_g.field_28025_B + (field_1388_h.field_6322_g.field_28026_A - field_1388_h.field_6322_g.field_28025_B) * p_4139_1_;
        if(f2 > 0.0F)
        {
            int i = 20;
    ...
    public void func_4136_b(float p_4136_1_)
    {
        ...
        if(field_1388_h.field_6289_L)
        {
            ...
            if(field_1388_h.field_6304_y.field_22274_D)
            {
                ...
                f2 = field_40684_J * f4;
                f3 = field_40685_K * f4;
                field_1388_h.field_6322_g.func_346_d(f2, f3 * (float)l);
            } else
            {
                field_1388_h.field_6322_g.func_346_d(f2, f3 * (float)l);
            }
        ...
        if(field_1388_h.field_6324_e != null)
        {
            ...
            {
                func_4134_c(p_4136_1_, field_28133_I + (long)(0x3b9aca00 / c));
            }
            ...
            {
                field_1388_h.field_6308_u.func_4066_a(p_4136_1_, field_1388_h.field_6313_p != null, k, i1);
            }
            Profiler.func_40662_b();
        } else
        {
        ...
        {
            GL11.glClear(256);
            field_1388_h.field_6313_p.func_571_a(k, i1, p_4136_1_);
    ...
    public void func_4134_c(float p_4134_1_, long p_4134_2_)
    {
        ...
        for(int i = 0; i < 2; i++)
        {
            ...
            if(field_1388_h.field_6304_y.field_1576_i)
            {
                ...
                int i1 = renderglobal.func_943_a(entityliving, 1, p_4134_1_);
                if(field_1388_h.field_6304_y.field_1578_g)
                {
                    if(field_28134_b == 0)
                    {
            ...
            {
                Profiler.func_40661_c("water");
                renderglobal.func_943_a(entityliving, 1, p_4134_1_);
            }
            GL11.glDepthMask(true);
            GL11.glEnable(2884);
            GL11.glDisable(3042);
    ...
    private void func_4137_h(float p_4137_1_)
    {
        ...
        if(field_1388_h.field_6304_y.field_1580_e < 2)
        {
            Vec3D vec3d2 = MathHelper.func_1106_a(world.func_35456_d(p_4137_1_)) <= 0.0F ? Vec3D.func_1248_b(1.0D, 0.0D, 0.0D) : Vec3D.func_1248_b(-1D, 0.0D, 0.0D);
