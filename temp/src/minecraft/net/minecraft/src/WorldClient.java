...
public class WorldClient extends World
{
    ...
    {
        int i = func_600_a(p_635_1_, p_635_2_, p_635_3_);
        int j = func_602_e(p_635_1_, p_635_2_, p_635_3_);
        return super.func_635_c(p_635_1_, p_635_2_, p_635_3_, p_635_4_);
    }

    public boolean func_643_a(int p_643_1_, int p_643_2_, int p_643_3_, int p_643_4_, int p_643_5_)
    {
        int i = func_600_a(p_643_1_, p_643_2_, p_643_3_);
        int j = func_602_e(p_643_1_, p_643_2_, p_643_3_);
        return super.func_643_a(p_643_1_, p_643_2_, p_643_3_, p_643_4_, p_643_5_);
    }

    public boolean func_634_a(int p_634_1_, int p_634_2_, int p_634_3_, int p_634_4_)
    {
        int i = func_600_a(p_634_1_, p_634_2_, p_634_3_);
        int j = func_602_e(p_634_1_, p_634_2_, p_634_3_);
        return super.func_634_a(p_634_1_, p_634_2_, p_634_3_, p_634_4_);
    }
