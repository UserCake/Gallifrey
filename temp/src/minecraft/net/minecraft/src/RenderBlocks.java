...
//            ModLoader, IBlockAccess, BlockEndPortalFrame, Tessellator, 
//            BlockBed, Direction, EntityRenderer, BlockRedstoneRepeater, 
//            BlockPistonBase, BlockPistonExtension, Vec3D, BlockFire, 
//            BlockRedstoneWire, BlockStem, Material, BlockFluid, 
//            MathHelper, World, BlockDirectional, BlockDoor, 
//            BlockGrass, ChestItemRenderHelper
...
public class RenderBlocks
{
    ...
    public boolean func_1234_a(Block p_1234_1_, int p_1234_2_, int p_1234_3_, int p_1234_4_)
    {
        ...
        return i != 0 ? i != 4 ? i != 13 ? i != 1 ? i != 19 ? i != 23 ? i != 6 ? i != 2 ? i != 3 ? i != 5 ? i != 8 ? i != 7 ? i != 9 ? i != 10 ? i != 27 ? i != 11 ? i != 12 ? i != 14 ? i != 15 ? i != 16 ? i != 17 ? i != 18 ? i != 20 ? i != 21 ? i != 24 ? i != 25 ? i != 26 ? ModLoader.renderWorldBlock(this, field_1772_a, p_1234_2_, p_1234_3_, p_1234_4_, p_1234_1_, i) : func_40729_s(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_40730_a((BlockBrewingStand)p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_40728_a((BlockCauldron)p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_35923_a((BlockFenceGate)p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_35929_i(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_35922_a((BlockPane)p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_31080_c(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_, true) : func_31074_b(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_, false) : func_22332_q(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_22331_p(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1229_c(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_35925_a((BlockFence)p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_41088_a((BlockDragonEgg)p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1214_n(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1216_f((BlockRail)p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1218_o(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1221_g(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1242_e(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1235_d(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1241_b(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_35930_l(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_40726_m(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1232_i(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1226_h(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1233_l(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1222_j(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_) : func_1228_k(p_1234_1_, p_1234_2_, p_1234_3_, p_1234_4_);
    }
    ...
    public boolean func_40728_a(BlockCauldron p_40728_1_, int p_40728_2_, int p_40728_3_, int p_40728_4_)
    {
        ...
        char c = '\232';
        float f5 = 0.125F;
        func_1236_f(p_40728_1_, ((float)p_40728_2_ - 1.0F) + f5, p_40728_3_, p_40728_4_, c);
        func_1231_e(p_40728_1_, ((float)p_40728_2_ + 1.0F) - f5, p_40728_3_, p_40728_4_, c);
        func_1225_d(p_40728_1_, p_40728_2_, p_40728_3_, ((float)p_40728_4_ - 1.0F) + f5, c);
        func_1220_c(p_40728_1_, p_40728_2_, p_40728_3_, ((float)p_40728_4_ + 1.0F) - f5, c);
        char c1 = '\213';
    ...
    public boolean func_1235_d(Block p_1235_1_, int p_1235_2_, int p_1235_3_, int p_1235_4_)
    {
        ...
        if(!field_1772_a.func_28100_h(p_1235_2_, p_1235_3_ - 1, p_1235_4_) && !Block.field_402_as.func_261_b(field_1772_a, p_1235_2_, p_1235_3_ - 1, p_1235_4_))
        {
            ...
            {
                tessellator.func_983_a((float)p_1235_2_ + f1, (float)p_1235_3_ + f + f2, p_1235_4_ + 1, d1, d2);
                tessellator.func_983_a(p_1235_2_ + 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 1, d1, d3);
                tessellator.func_983_a(p_1235_2_ + 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 0, d, d3);
                tessellator.func_983_a((float)p_1235_2_ + f1, (float)p_1235_3_ + f + f2, p_1235_4_ + 0, d, d2);
                tessellator.func_983_a((float)p_1235_2_ + f1, (float)p_1235_3_ + f + f2, p_1235_4_ + 0, d, d2);
                tessellator.func_983_a(p_1235_2_ + 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 0, d, d3);
                tessellator.func_983_a(p_1235_2_ + 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 1, d1, d3);
                tessellator.func_983_a((float)p_1235_2_ + f1, (float)p_1235_3_ + f + f2, p_1235_4_ + 1, d1, d2);
            ...
            if(Block.field_402_as.func_261_b(field_1772_a, p_1235_2_ + 1, p_1235_3_, p_1235_4_))
            {
                tessellator.func_983_a((float)(p_1235_2_ + 1) - f1, (float)p_1235_3_ + f + f2, p_1235_4_ + 0, d, d2);
                tessellator.func_983_a((p_1235_2_ + 1) - 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 0, d, d3);
                tessellator.func_983_a((p_1235_2_ + 1) - 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 1, d1, d3);
                tessellator.func_983_a((float)(p_1235_2_ + 1) - f1, (float)p_1235_3_ + f + f2, p_1235_4_ + 1, d1, d2);
                tessellator.func_983_a((float)(p_1235_2_ + 1) - f1, (float)p_1235_3_ + f + f2, p_1235_4_ + 1, d1, d2);
                tessellator.func_983_a((p_1235_2_ + 1) - 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 1, d1, d3);
                tessellator.func_983_a((p_1235_2_ + 1) - 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 0, d, d3);
                tessellator.func_983_a((float)(p_1235_2_ + 1) - f1, (float)p_1235_3_ + f + f2, p_1235_4_ + 0, d, d2);
            ...
            {
                tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f + f2, (float)p_1235_4_ + f1, d1, d2);
                tessellator.func_983_a(p_1235_2_ + 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 0, d1, d3);
                tessellator.func_983_a(p_1235_2_ + 1, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 0, d, d3);
                tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f + f2, (float)p_1235_4_ + f1, d, d2);
                tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f + f2, (float)p_1235_4_ + f1, d, d2);
                tessellator.func_983_a(p_1235_2_ + 1, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 0, d, d3);
                tessellator.func_983_a(p_1235_2_ + 0, (float)(p_1235_3_ + 0) + f2, p_1235_4_ + 0, d1, d3);
                tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f + f2, (float)p_1235_4_ + f1, d1, d2);
            ...
            if(Block.field_402_as.func_261_b(field_1772_a, p_1235_2_, p_1235_3_, p_1235_4_ + 1))
            {
                tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f + f2, (float)(p_1235_4_ + 1) - f1, d, d2);
                tessellator.func_983_a(p_1235_2_ + 1, (float)(p_1235_3_ + 0) + f2, (p_1235_4_ + 1) - 0, d, d3);
                tessellator.func_983_a(p_1235_2_ + 0, (float)(p_1235_3_ + 0) + f2, (p_1235_4_ + 1) - 0, d1, d3);
                tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f + f2, (float)(p_1235_4_ + 1) - f1, d1, d2);
                tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f + f2, (float)(p_1235_4_ + 1) - f1, d1, d2);
                tessellator.func_983_a(p_1235_2_ + 0, (float)(p_1235_3_ + 0) + f2, (p_1235_4_ + 1) - 0, d1, d3);
                tessellator.func_983_a(p_1235_2_ + 1, (float)(p_1235_3_ + 0) + f2, (p_1235_4_ + 1) - 0, d, d3);
                tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f + f2, (float)(p_1235_4_ + 1) - f1, d, d2);
            ...
            {
                double d5 = (double)p_1235_2_ + 0.5D + 0.5D;
                double d7 = ((double)p_1235_2_ + 0.5D) - 0.5D;
                double d9 = (double)p_1235_4_ + 0.5D + 0.5D;
                double d11 = ((double)p_1235_4_ + 0.5D) - 0.5D;
                double d13 = ((double)p_1235_2_ + 0.5D) - 0.5D;
                double d15 = (double)p_1235_2_ + 0.5D + 0.5D;
                ...
                {
                    tessellator.func_983_a(d13, (float)p_1235_3_ + f, p_1235_4_ + 0, d1, d2);
                    tessellator.func_983_a(d5, p_1235_3_ + 0, p_1235_4_ + 0, d1, d3);
                    tessellator.func_983_a(d5, p_1235_3_ + 0, p_1235_4_ + 1, d, d3);
                    tessellator.func_983_a(d13, (float)p_1235_3_ + f, p_1235_4_ + 1, d, d2);
                    d = (float)j / 256F;
                    d1 = ((float)j + 15.99F) / 256F;
                    d2 = (float)(k + 16) / 256F;
                    d3 = ((float)k + 15.99F + 16F) / 256F;
                    tessellator.func_983_a(d15, (float)p_1235_3_ + f, p_1235_4_ + 1, d1, d2);
                    tessellator.func_983_a(d7, p_1235_3_ + 0, p_1235_4_ + 1, d1, d3);
                    tessellator.func_983_a(d7, p_1235_3_ + 0, p_1235_4_ + 0, d, d3);
                    tessellator.func_983_a(d15, (float)p_1235_3_ + f, p_1235_4_ + 0, d, d2);
                } else
                {
                    tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f, d20, d1, d2);
                    tessellator.func_983_a(p_1235_2_ + 0, p_1235_3_ + 0, d11, d1, d3);
                    tessellator.func_983_a(p_1235_2_ + 1, p_1235_3_ + 0, d11, d, d3);
                    tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f, d20, d, d2);
                    d = (float)j / 256F;
                    d1 = ((float)j + 15.99F) / 256F;
                    d2 = (float)(k + 16) / 256F;
                    d3 = ((float)k + 15.99F + 16F) / 256F;
                    tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f, d17, d1, d2);
                    tessellator.func_983_a(p_1235_2_ + 1, p_1235_3_ + 0, d9, d1, d3);
                    tessellator.func_983_a(p_1235_2_ + 0, p_1235_3_ + 0, d9, d, d3);
                    tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f, d17, d, d2);
                }
            }
        } else
        {
            double d19 = (double)p_1235_2_ + 0.5D + 0.20000000000000001D;
            double d6 = ((double)p_1235_2_ + 0.5D) - 0.20000000000000001D;
            double d8 = (double)p_1235_4_ + 0.5D + 0.20000000000000001D;
            double d10 = ((double)p_1235_4_ + 0.5D) - 0.20000000000000001D;
            double d12 = ((double)p_1235_2_ + 0.5D) - 0.29999999999999999D;
            double d14 = (double)p_1235_2_ + 0.5D + 0.29999999999999999D;
            double d16 = ((double)p_1235_4_ + 0.5D) - 0.29999999999999999D;
            double d18 = (double)p_1235_4_ + 0.5D + 0.29999999999999999D;
            tessellator.func_983_a(d12, (float)p_1235_3_ + f, p_1235_4_ + 1, d1, d2);
            tessellator.func_983_a(d19, p_1235_3_ + 0, p_1235_4_ + 1, d1, d3);
            tessellator.func_983_a(d19, p_1235_3_ + 0, p_1235_4_ + 0, d, d3);
            tessellator.func_983_a(d12, (float)p_1235_3_ + f, p_1235_4_ + 0, d, d2);
            tessellator.func_983_a(d14, (float)p_1235_3_ + f, p_1235_4_ + 0, d1, d2);
            tessellator.func_983_a(d6, p_1235_3_ + 0, p_1235_4_ + 0, d1, d3);
            tessellator.func_983_a(d6, p_1235_3_ + 0, p_1235_4_ + 1, d, d3);
            tessellator.func_983_a(d14, (float)p_1235_3_ + f, p_1235_4_ + 1, d, d2);
            d = (float)j / 256F;
            d1 = ((float)j + 15.99F) / 256F;
            d2 = (float)(k + 16) / 256F;
            d3 = ((float)k + 15.99F + 16F) / 256F;
            tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f, d18, d1, d2);
            tessellator.func_983_a(p_1235_2_ + 1, p_1235_3_ + 0, d10, d1, d3);
            tessellator.func_983_a(p_1235_2_ + 0, p_1235_3_ + 0, d10, d, d3);
            tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f, d18, d, d2);
            tessellator.func_983_a(p_1235_2_ + 0, (float)p_1235_3_ + f, d16, d1, d2);
            tessellator.func_983_a(p_1235_2_ + 0, p_1235_3_ + 0, d8, d1, d3);
            tessellator.func_983_a(p_1235_2_ + 1, p_1235_3_ + 0, d8, d, d3);
            tessellator.func_983_a(p_1235_2_ + 1, (float)p_1235_3_ + f, d16, d, d2);
            d19 = ((double)p_1235_2_ + 0.5D) - 0.5D;
            d6 = (double)p_1235_2_ + 0.5D + 0.5D;
            d8 = ((double)p_1235_4_ + 0.5D) - 0.5D;
            d10 = (double)p_1235_4_ + 0.5D + 0.5D;
            d12 = ((double)p_1235_2_ + 0.5D) - 0.40000000000000002D;
            d14 = (double)p_1235_2_ + 0.5D + 0.40000000000000002D;
            d16 = ((double)p_1235_4_ + 0.5D) - 0.40000000000000002D;
            d18 = (double)p_1235_4_ + 0.5D + 0.40000000000000002D;
            tessellator.func_983_a(d12, (float)p_1235_3_ + f, p_1235_4_ + 0, d, d2);
            tessellator.func_983_a(d19, p_1235_3_ + 0, p_1235_4_ + 0, d, d3);
            tessellator.func_983_a(d19, p_1235_3_ + 0, p_1235_4_ + 1, d1, d3);
            tessellator.func_983_a(d12, (float)p_1235_3_ + f, p_1235_4_ + 1, d1, d2);
    ...
    public boolean func_1221_g(Block p_1221_1_, int p_1221_2_, int p_1221_3_, int p_1221_4_)
    {
        ...
        double d2 = (float)k / 256F;
        double d3 = ((float)k + 15.99F) / 256F;
        int l = field_1772_a.func_602_e(p_1221_2_, p_1221_3_, p_1221_4_);
        double d4 = 0.0D;
    ...
    public boolean func_35929_i(Block p_35929_1_, int p_35929_2_, int p_35929_3_, int p_35929_4_)
    {
        ...
        int l = field_1772_a.func_602_e(p_35929_2_, p_35929_3_, p_35929_4_);
        if((l & 2) != 0)
        {
    ...
    public boolean func_35922_a(BlockPane p_35922_1_, int p_35922_2_, int p_35922_3_, int p_35922_4_)
    {
        ...
        {
            int k = field_1772_a.func_602_e(p_35922_2_, p_35922_3_, p_35922_4_);
            i1 = p_35922_1_.func_232_a(0, k);
            j1 = p_35922_1_.func_35299_s();
        }
        int l = (i1 & 0xf) << 4;
        int k1 = i1 & 0xf0;
        double d = (float)l / 256F;
        ...
        boolean flag2 = p_35922_1_.func_35298_d(field_1772_a.func_600_a(p_35922_2_, p_35922_3_, p_35922_4_ - 1));
        boolean flag3 = p_35922_1_.func_35298_d(field_1772_a.func_600_a(p_35922_2_, p_35922_3_, p_35922_4_ + 1));
        boolean flag4 = p_35922_1_.func_35298_d(field_1772_a.func_600_a(p_35922_2_ - 1, p_35922_3_, p_35922_4_));
        boolean flag5 = p_35922_1_.func_35298_d(field_1772_a.func_600_a(p_35922_2_ + 1, p_35922_3_, p_35922_4_));
        boolean flag6 = p_35922_1_.func_260_c(field_1772_a, p_35922_2_, p_35922_3_ + 1, p_35922_4_, 1);
        boolean flag7 = p_35922_1_.func_260_c(field_1772_a, p_35922_2_, p_35922_3_ - 1, p_35922_4_, 0);
        if((!flag4 || !flag5) && (flag4 || flag5 || flag2 || flag3))
        {
            if(flag4 && !flag5)
            {
                ...
                if(flag6 || p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_ - 1, p_35922_3_ + 1, p_35922_4_))
                {
                ...
                if(flag7 || p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_ - 1, p_35922_3_ - 1, p_35922_4_))
                {
        ...
        if((!flag2 || !flag3) && (flag4 || flag5 || flag2 || flag3))
        {
            if(flag2 && !flag3)
            {
                ...
                if(flag6 || p_35922_3_ < i - 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ + 1, p_35922_4_ - 1))
                {
                ...
                if(flag7 || p_35922_3_ > 1 && field_1772_a.func_20084_d(p_35922_2_, p_35922_3_ - 1, p_35922_4_ - 1))
                {
    ...
    public boolean func_1222_j(Block p_1222_1_, int p_1222_2_, int p_1222_3_, int p_1222_4_)
    {
        ...
        boolean aflag[] = {
            p_1222_1_.func_260_c(field_1772_a, p_1222_2_, p_1222_3_, p_1222_4_ - 1, 2), p_1222_1_.func_260_c(field_1772_a, p_1222_2_, p_1222_3_, p_1222_4_ + 1, 3), p_1222_1_.func_260_c(field_1772_a, p_1222_2_ - 1, p_1222_3_, p_1222_4_, 4), p_1222_1_.func_260_c(field_1772_a, p_1222_2_ + 1, p_1222_3_, p_1222_4_, 5)
        };
        ...
        if(field_1773_d || flag)
        {
            ...
            float f7 = (float)BlockFluid.func_293_a(field_1772_a, p_1222_2_, p_1222_3_, p_1222_4_, material);
            if(f7 > -999F)
            {
        ...
        for(int l = 0; l < 4; l++)
        {
            ...
            int i2 = p_1222_1_.func_232_a(l + 2, j);
            int j2 = (i2 & 0xf) << 4;
            int k2 = i2 & 0xf0;
            if(field_1773_d || aflag[l])
            {
                ...
                if(l == 0)
                {
                    ...
                    d14 = p_1222_2_;
                    d16 = p_1222_2_ + 1;
                    d13 = (double)p_1222_4_ + d6;
                    d15 = (double)p_1222_4_ + d6;
                } else
                if(l == 1)
                {
                    d11 = d4;
                    ...
                    d14 = p_1222_2_ + 1;
                    d16 = p_1222_2_;
                    d13 = (double)(p_1222_4_ + 1) - d6;
                    d15 = (double)(p_1222_4_ + 1) - d6;
                } else
                if(l == 2)
                {
                    d11 = d3;
                    d9 = d2;
                    d14 = (double)p_1222_2_ + d6;
                    d16 = (double)p_1222_2_ + d6;
                    d13 = p_1222_4_ + 1;
                    d15 = p_1222_4_;
                } else
                {
                    d11 = d5;
                    d9 = d4;
                    d14 = (double)(p_1222_2_ + 1) - d6;
                    d16 = (double)(p_1222_2_ + 1) - d6;
                    d13 = p_1222_4_;
                    d15 = p_1222_4_ + 1;
                }
                flag2 = true;
                ...
                tessellator.func_35835_b(p_1222_1_.func_35275_c(field_1772_a, k1, p_1222_3_, j1));
                float f10 = 1.0F;
                if(l < 2)
                {
                    f10 *= f5;
                ...
                tessellator.func_983_a(d14, (double)p_1222_3_ + d11, d13, d17, d19);
                tessellator.func_983_a(d16, (double)p_1222_3_ + d9, d15, d18, d20);
                tessellator.func_983_a(d16, p_1222_3_ + 0, d15, d18, d21);
                tessellator.func_983_a(d14, p_1222_3_ + 0, d13, d17, d21);
            }
        }
    ...
    public float func_1224_a(int p_1224_1_, int p_1224_2_, int p_1224_3_, Material p_1224_4_)
    {
        ...
        {
            int k = p_1224_1_ - (j & 1);
            int l = p_1224_3_ - (j >> 1 & 1);
            if(field_1772_a.func_599_f(k, p_1224_2_ + 1, l) == p_1224_4_)
            {
                return 1.0F;
            }
            Material material = field_1772_a.func_599_f(k, p_1224_2_, l);
            if(material == p_1224_4_)
            {
                int i1 = field_1772_a.func_602_e(k, p_1224_2_, l);
                if(i1 >= 8 || i1 == 0)
                {
                    f += BlockFluid.func_288_b(i1) * 10F;
                    i += 10;
                }
                f += BlockFluid.func_288_b(i1);
                i++;
            } else
    ...
    public boolean func_1228_k(Block p_1228_1_, int p_1228_2_, int p_1228_3_, int p_1228_4_)
    {
        ...
        return !Minecraft.func_22005_v() || Block.field_339_t[p_1228_1_.field_376_bc] != 0 ? func_4152_a(p_1228_1_, p_1228_2_, p_1228_3_, p_1228_4_, f, f1, f2) : func_22330_a(p_1228_1_, p_1228_2_, p_1228_3_, p_1228_4_, f, f1, f2);
    }
    ...
    public boolean func_22330_a(Block p_22330_1_, int p_22330_2_, int p_22330_3_, int p_22330_4_, float p_22330_5_, float p_22330_6_, float p_22330_7_)
    {
        ...
        if(field_1773_d || p_22330_1_.func_260_c(field_1772_a, p_22330_2_, p_22330_3_, p_22330_4_ + 1, 3))
        {
            ...
            if(cfgGrassFix && i2 == 3 && field_1771_b < 0)
            {
                field_22351_H *= p_22330_5_;
                field_22350_I *= p_22330_5_;
                field_22349_J *= p_22330_5_;
        ...
        if(field_1773_d || p_22330_1_.func_260_c(field_1772_a, p_22330_2_ - 1, p_22330_3_, p_22330_4_, 4))
        {
            ...
            if(cfgGrassFix && j2 == 3 && field_1771_b < 0)
            {
                field_22351_H *= p_22330_5_;
                field_22350_I *= p_22330_5_;
                field_22349_J *= p_22330_5_;
    ...
    public boolean func_4152_a(Block p_4152_1_, int p_4152_2_, int p_4152_3_, int p_4152_4_, float p_4152_5_, float p_4152_6_, float p_4152_7_)
    {
        ...
        if(field_1773_d || p_4152_1_.func_260_c(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_ - 1, 2))
        {
            ...
            if(cfgGrassFix && j == 3 && field_1771_b < 0)
            {
        ...
        if(field_1773_d || p_4152_1_.func_260_c(field_1772_a, p_4152_2_, p_4152_3_, p_4152_4_ + 1, 3))
        {
            ...
            if(cfgGrassFix && k == 3 && field_1771_b < 0)
            {
                tessellator.func_987_a(f8 * p_4152_5_, f11 * p_4152_6_, f14 * p_4152_7_);
        ...
        if(field_1773_d || p_4152_1_.func_260_c(field_1772_a, p_4152_2_ - 1, p_4152_3_, p_4152_4_, 4))
        {
            ...
            if(cfgGrassFix && l == 3 && field_1771_b < 0)
            {
    ...
    public boolean func_35923_a(BlockFenceGate p_35923_1_, int p_35923_2_, int p_35923_3_, int p_35923_4_)
    {
        ...
        if(j != 3 && j != 1)
        {
            ...
            float f4 = 0.4375F;
            float f12 = 0.5625F;
            p_35923_1_.func_213_a(f, 0.3125F, f4, f8, 1.0F, f12);
        ...
        } else
        {
            ...
            float f5 = 0.0F;
            float f13 = 0.125F;
            p_35923_1_.func_213_a(f1, 0.3125F, f5, f9, 1.0F, f13);
            func_1228_k(p_35923_1_, p_35923_2_, p_35923_3_, p_35923_4_);
            f5 = 0.875F;
            f13 = 1.0F;
            p_35923_1_.func_213_a(f1, 0.3125F, f5, f9, 1.0F, f13);
        ...
        if(!flag1)
        {
            if(j != 3 && j != 1)
            {
                ...
                float f6 = 0.4375F;
                float f14 = 0.5625F;
                p_35923_1_.func_213_a(f2, 0.375F, f6, f10, 0.9375F, f14);
                func_1228_k(p_35923_1_, p_35923_2_, p_35923_3_, p_35923_4_);
                f2 = 0.5F;
                f10 = 0.625F;
                p_35923_1_.func_213_a(f2, 0.375F, f6, f10, 0.9375F, f14);
                ...
                f2 = 0.625F;
                f10 = 0.875F;
                p_35923_1_.func_213_a(f2, 0.375F, f6, f10, 0.5625F, f14);
                func_1228_k(p_35923_1_, p_35923_2_, p_35923_3_, p_35923_4_);
                p_35923_1_.func_213_a(f2, 0.75F, f6, f10, 0.9375F, f14);
                func_1228_k(p_35923_1_, p_35923_2_, p_35923_3_, p_35923_4_);
                f2 = 0.125F;
                f10 = 0.375F;
                p_35923_1_.func_213_a(f2, 0.375F, f6, f10, 0.5625F, f14);
            ...
            } else
            {
                ...
                float f7 = 0.375F;
                float f15 = 0.5F;
                p_35923_1_.func_213_a(f3, 0.375F, f7, f11, 0.9375F, f15);
                func_1228_k(p_35923_1_, p_35923_2_, p_35923_3_, p_35923_4_);
                f7 = 0.5F;
                f15 = 0.625F;
                p_35923_1_.func_213_a(f3, 0.375F, f7, f11, 0.9375F, f15);
                ...
                f7 = 0.625F;
                f15 = 0.875F;
                p_35923_1_.func_213_a(f3, 0.375F, f7, f11, 0.5625F, f15);
                func_1228_k(p_35923_1_, p_35923_2_, p_35923_3_, p_35923_4_);
                p_35923_1_.func_213_a(f3, 0.75F, f7, f11, 0.9375F, f15);
                func_1228_k(p_35923_1_, p_35923_2_, p_35923_3_, p_35923_4_);
                f7 = 0.125F;
                f15 = 0.375F;
                p_35923_1_.func_213_a(f3, 0.375F, f7, f11, 0.5625F, f15);
        ...
        if(j != 0 && j != 16)
        {
            ...
            if(j == 11)
            {
                for(int i1 = 0; i1 < 4; i1++)
                {
                    ...
                    if(i1 == 0)
                    {
                        p_1227_1_.func_213_a(0.5F - f3, 0.0F, 0.0F, 0.5F + f3, 1.0F, f3 * 2.0F);
                    }
                    if(i1 == 1)
                    {
                        p_1227_1_.func_213_a(0.5F - f3, 0.0F, 1.0F - f3 * 2.0F, 0.5F + f3, 1.0F, 1.0F);
                    }
                    f3 = 0.0625F;
                    if(i1 == 2)
                    {
                        p_1227_1_.func_213_a(0.5F - f3, 1.0F - f3 * 3F, -f3 * 2.0F, 0.5F + f3, 1.0F - f3, 1.0F + f3 * 2.0F);
                    }
                    if(i1 == 3)
                    {
                        p_1227_1_.func_213_a(0.5F - f3, 0.5F - f3 * 3F, -f3 * 2.0F, 0.5F + f3, 0.5F - f3, 1.0F + f3 * 2.0F);
                    }
                    GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
                    tessellator.func_977_b();
                    tessellator.func_980_b(0.0F, -1F, 0.0F);
            ...
            if(j == 21)
            {
                for(int j1 = 0; j1 < 3; j1++)
                {
                    ...
                    if(j1 == 0)
                    {
                        p_1227_1_.func_213_a(0.5F - f4, 0.3F, 0.0F, 0.5F + f4, 1.0F, f4 * 2.0F);
                    }
                    if(j1 == 1)
                    {
                        p_1227_1_.func_213_a(0.5F - f4, 0.3F, 1.0F - f4 * 2.0F, 0.5F + f4, 1.0F, 1.0F);
                    }
                    f4 = 0.0625F;
                    if(j1 == 2)
                    {
                        p_1227_1_.func_213_a(0.5F - f4, 0.5F, 0.0F, 0.5F + f4, 1.0F - f4, 1.0F);
                    }
                    GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
                    tessellator.func_977_b();
                    tessellator.func_980_b(0.0F, -1F, 0.0F);
            ...
            {
                ModLoader.renderInvBlock(this, p_1227_1_, p_1227_2_, j);
            }
        } else
        {
            if(j == 16)
            ...
            {
                int k1 = p_1227_1_.func_31030_b(p_1227_2_);
                float f5 = (float)(k1 >> 16 & 0xff) / 255F;
                float f7 = (float)(k1 >> 8 & 0xff) / 255F;
                float f8 = (float)(k1 & 0xff) / 255F;
                GL11.glColor4f(f5 * p_1227_3_, f7 * p_1227_3_, f8 * p_1227_3_, 1.0F);
            }
            tessellator.func_977_b();
            tessellator.func_980_b(0.0F, 1.0F, 0.0F);
    ...
    {
        return p_1219_0_ != 0 ? p_1219_0_ != 13 ? p_1219_0_ != 10 ? p_1219_0_ != 11 ? p_1219_0_ != 27 ? p_1219_0_ != 22 ? p_1219_0_ != 21 ? ModLoader.renderBlockIsItemFull3D(p_1219_0_) : true : true : true : true : true : true : true;
    }
