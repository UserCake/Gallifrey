...
public class GuiTextField extends Gui
{
    ...
    public void func_50031_b(String p_50031_1_)
    {
        ...
        if(k < p_50031_1_.length())
        {
            s = (new StringBuilder()).append(s).append(p_50031_1_.substring(0, k)).toString();
            l = k;
        } else
        {
            s = (new StringBuilder()).append(s).append(p_50031_1_).toString();
            l = p_50031_1_.length();
        }
    ...
    public void func_22069_a(int p_22069_1_, int p_22069_2_, int p_22069_3_)
    {
        ...
        if(field_22082_a && p_22069_3_ == 0)
        {
            ...
            int j = p_22069_2_ - field_22078_e;
            if(field_50044_j)
            {
                i -= 4;
            }
